...
<div id="ss-plugin" class="wrap">
	...
	<form method="post" action="" name="ss">
		...
		<div class="checkbox switcher">
			...
			<small>
			<span style="font-size:16px!important;">Only Use the Plugin for Standard WordPress Forms (not recommended) </span></small></label><i class="fa fa-question-circle fa-2x tooltip"><span class="tooltiptext">
				...
				<br/>
			<span style="font-weight:bold;font-size:18px;">Login Preferences <sup class="ss_sup">NEW!</sup></span>
			<p>Allow users to login using their username and/or e-mail address.</p>
			<div class="radio-wrapper">
				<ul class="ss-spacer">
					<li>
						<input name="login_type" type="radio" id="ss-login-type-default" value="default" <?php echo ((!isset($login_type) or $login_type == 'default') ? 'checked="checked"' : ''); ?>>
						<label for="ss-login-type-default">Username or E-mail</label>
					</li>
					<li>
						<input name="login_type" type="radio" id="ss-login-type-username" value="username" <?php echo (@$login_type == 'username' ? 'checked="checked"' : ''); ?>>
						<label for="ss-login-type-username">Username only</label>
					</li>
					<li>
						<input name="login_type" type="radio" id="ss-login-type-email" value="email" <?php echo (@$login_type == 'email' ? 'checked="checked"' : ''); ?>>
						<label for="ss-login-type-email">E-mail only</label>
					</li>
				</ul>
			</div>
			...
			<div class="checkbox switcher">
				<label id="ss_subhead" for="enable-custom-password">
					<input class="ss_toggle" type="checkbox" id="enable-custom-password" name="enable_custom_password" value="Y" <?php if ( @$enable_custom_password == 'Y' ) { echo "checked=\"checked\""; } ?> /><span><small></small></span>
					<small>
	...
	<div class="checkbox switcher">
	 ...
	 <div class="checkbox switcher">
	  <label id="ss_subhead" for="chkperiods">
		  ...
		  <small><span style="font-size:16px!important;">Check for Periods</span></small></label><i class="fa fa-question-circle fa-2x tooltip"><span class="tooltiptext">                 
	 ...
	 <div class="checkbox switcher">
	  <label id="ss_subhead" for="chkhyphens">
		  ...
		  <small><span style="font-size:16px!important;">Check for Hyphens</span></small></label><i class="fa fa-question-circle fa-2x tooltip"><span class="tooltiptext">                 
  ...
  if (checkBox.checked == true){
   ...
   <div class="checkbox switcher">
	  <label id="ss_subhead" for="chktor">
		  ...
		  <small><span style="font-size:16px!important;">Check for Tor Exit Nodes</span></small></label><i class="fa fa-question-circle fa-2x tooltip"><span class="tooltiptext">                 
