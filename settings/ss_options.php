...
<div id="ss-plugin" class="wrap">
    ...
    <form method="post" action="" name="ss">
        ...
        <fieldset>
            <legend><span
                        style="font-weight:bold;font-size:1.2em">Only Use the Plugin for Standard WordPress Forms</span>
            </legend>
            <p><input name="chkform" type="checkbox" value="Y" <?php if ( $chkform == 'Y' ) {
                ...
                wp-comments-post.php and wp-login.php. WooCommerce and other plugins will not be checked. Use this
                option
        ...
        <fieldset>
            ...
            <fieldset>
                <legend><span style="font-weight:bold;font-size:1.2em">Automatically Add Admins to Allow List</span>
                </legend>
                <p><input name="addtoallowlist" type="checkbox" value="Y" <?php if ( $addtoallowlist == 'Y' ) {
						echo "checked=\"checked\"";
					} ?> />
                    Whenever an administrative user logs in, the IP address is added to the Allow List. This means that
                    you can't be locked out unless your IP address changes or you log in from a different location. As
                    soon as a login is successful then the IP is white-listed to prevent future problems. Disable this
                    if you think that you will never be locked out.</p>
            </fieldset>
            <br />
            <fieldset>
                <legend><span style="font-weight:bold;font-size:1.2em">Check Credentials on All Login Attempts</span>
                </legend>
        ...
        <fieldset>
            ...
            <fieldset>
                ...
                <p><input name="chkdisp" type="checkbox" value="Y" <?php if ( $chkdisp == 'Y' ) {
                    ...
                    Spammers who want to hide their true identities use disposable email addresses. You can get these
                    from a number of sites. The spammer doesn't have to register. He just picks up any mail anonymously.
                    Legitimate users use their real email address. It is very likely that anyone using a disposable
                    email address is a spammer.</p>
            </fieldset>
            <br />
            <fieldset>
                <legend><span
                            style="font-weight:bold;font-size:1.2em">Check for Long Emails, Author Name, or Password</span>
                </legend>
            ...
            <fieldset>
                <legend><span style="font-weight:bold;font-size:1.2em">Check for Short Emails or Author Name</span>
                </legend>
                <p><input name="chkshort" type="checkbox" value="Y" <?php if ( $chkshort == 'Y' ) {
						echo "checked=\"checked\"";
					} ?> />
                    Spammers sometimes use blank usernames or author names. If you are having trouble with a plugin or
                    theme
            ...
            <fieldset>
                ...
                <p><input name="chkbbcode" type="checkbox" value="Y" <?php if ( $chkbbcode == 'Y' ) {
                    ...
                    BBCodes are codes like [url] that spammers like to place in comments. WordPress does not support
                    BBCodes without a plugin.
                    If you have a BBCode plugin then disable this. This will mark any comment that has BBCodes as spam.
                </p>
            </fieldset>
            <br />
            <fieldset>
            ...
            <fieldset>
                ...
                <p><input name="chkexploits" type="checkbox" value="Y" <?php if ( $chkexploits == 'Y' ) {
                    ...
                    This checks for the PHP eval function and typical SQL injection strings in comments and login
                    attempts. It also checks for JavaScript that may potentially be used for cross domain exploits.</p>
            </fieldset>
            <br />
            <fieldset>
                <legend><span
                            style="font-weight:bold;font-size:1.2em">Deny Login Attempts Using 'admin' in Username</span>
                </legend>
            ...
            <br />
            <fieldset>
                <legend><span style="font-weight:bold;font-size:1.2em">Check Against List of Ubiquity-Nobis and Other Spam Server IPs</span>
                </legend>
            ...
            <br />
            <fieldset>
                <legend><span style="font-weight:bold;font-size:1.2em">Check for Major Hosting Companies and Cloud Services</span>
                </legend>
                <p><input name="chkhosting" type="checkbox" value="Y" <?php if ( $chkhosting == 'Y' ) {
						echo "checked=\"checked\"";
					} ?> />
                    Your users should come from ISPs only. If a request comes from a web host such as Softlayer,
                    Rackspace, or Amazon AWS, it is likely that the the user is a spammer who is running some spam
                    software to attack your site.</p>
            </fieldset>
            <br />
            <fieldset>
                <legend><span style="font-weight:bold;font-size:1.2em">Check for Many Hits in a Short Time</span>
                </legend>
                <p><input name="chkmulti" type="checkbox" value="Y" <?php if ( $chkmulti == 'Y' ) {
                    ...
                    minutes.<br />
                    Spammers hit your site over and over again. If you get more than 5 hits in 3 minutes, the spammer
                    will be stopped,
            ...
            <fieldset>
                ...
                <p><input name="chkamazon" type="checkbox" value="Y" <?php if ( $chkamazon == 'Y' ) {
                    ...
                    You can block comments and logins from Amazon Cloud Servers using this setting. It may be that good
                    services use
                    Amazon Cloud servers so you may not want to use this. Be careful about blocking Amazon. Sometimes
                    you get spam from
            ...
            <fieldset>
                ...
                <p><input name="filterregistrations" type="checkbox"
                    ...
                    Some plugins and themes bypass the standard registration forms. If you check this, Stop Spammers
                    will try to intercept the login in the WordPress user login module. This will cause some overhead,
                    but gives Stop Spammers another shot at detecting spam. This is turned off by default because it
            ...
            <fieldset>
                ...
                <p>If you block countries, make sure that you have set the Challenge to use a CAPTCHA screen so that
                    legitimate users
                    can get into your site even if blocked.</p>
                <p>The biggest countries can put a strain on memory. US, Russia, India, Ukraine, Brazil, China, and
