...
<div id="ss-plugin" class="wrap">
    <h1 class="ss_head">Stop Spammers — <?php __( 'Web Services', 'stop-spammer-registrations-plugin' ); ?></h1>
	<?php if ( ! empty( $msg ) ) {
		echo "$msg";
	} ?>
	<br />
	<div class="ss_info_box">
    <p><?php __( 'Below are several services that can be enabled to check for spam or protect
        your website against spammers. To learn more about each service and find links to create keys, please <a href="https://stopspammers.io/web-services" target="_blank">review our documentation</a>.', 'stop-spammer-registrations-plugin' ); ?></p></div>
	<br />
    <form method="post" action="">
      ...
      <label id="ss_subhead" for="chkdnsbl">
		  ...
		  <small><span style="font-size:16px!important;"><?php __( 'Check Against DNSBL Lists Such as Spamhaus.org', 'stop-spammer-registrations-plugin' ); ?></span></small></label></div>      
        <br />		
			<div class="checkbox switcher">
      <label id="ss_subhead" for="chksfs">
		  ...
		  <small><span style="font-size:16px!important;"><?php __( 'Enable Stop Forum Spam Lookups', 'stop-spammer-registrations-plugin' ); ?></span></small></label></div>
				<br />
            <table cellspacing="1" style="background-color:#ccc;font-size:0.9em;margin-left:30px;">
                <tr bgcolor="white">
                    <td valign="top"><?php __( 'Deny spammers found on Stop Forum Spam with
                        more than
                        <input size="3" name="sfsfreq" type="text" class="small-text" value="' . echo $sfsfreq . '" />
                        incidents, and occurring less than
                        <input size="4" name="sfsage" type="text" class="small-text" value="' . echo $sfsage . '" />
			...
			<br />
        <br />
				<span class="keyhead"><?php __( 'StopForumSpam.com API Key', 'stop-spammer-registrations-plugin' ); ?></span>
            <input size="32" name="apikey" type="text" value="<?php echo $apikey; ?>" /><br />
			<br />
				<span class="keyhead"><?php __( 'Project Honeypot API Key', 'stop-spammer-registrations-plugin' ); ?></span>
            <input size="32" name="honeyapi" type="text" value="<?php echo $honeyapi; ?>" /><br />
			<br />
            <table cellspacing="1" style="background-color:#ccc;font-size:0.9em;margin-left:30px;">
                <tr bgcolor="white">
                    <td valign="top"><?php __( 'Deny spammers found on Project HoneyPot
                        with incidents less than
                        <input size="3" name="hnyage" type="text" class="small-text" value="' . echo $hnyage . '" />
                        days ago, and with more than
                        <input size="4" name="hnylevel" type="text" class="small-text" value="' . echo $hnylevel . '" />
        ...
        <br />
	<br />
			<span class="keyhead"><?php __( 'BotScout API Key', 'stop-spammer-registrations-plugin' ); ?></span>
            <input size="32" name="botscoutapi" type="text" value="<?php echo $botscoutapi; ?>" /><br />
		<br />
            <table cellspacing="1" style="background-color:#ccc;font-size:0.9em;margin-left:30px;">
                <tr bgcolor="white">
                    <td valign="top"><?php __( 'Deny spammers found on BotScout with more
                        than
                        <input size="3" name="botfreq" type="text" class="small-text" value="' . echo $botfreq . '" />
        ...
        <br />
	<br />
			<span class="keyhead"><?php __( 'Google Safe Browsing API Key', 'stop-spammer-registrations-plugin' ); ?></span>
