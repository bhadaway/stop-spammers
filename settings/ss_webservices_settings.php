...
<div id="ss-plugin" class="wrap">
    ...
    <p><?php _e( 'Below are several services that can be enabled to check for spam or protect
    ...
    <form method="post" action="">
      ...
      <label id="ss_subhead" for="chkdnsbl">
		  ...
		  <small><span style="font-size:16px!important;"><?php _e( 'Check Against DNSBL Lists Such as Spamhaus.org', 'stop-spammer-registrations-plugin' ); ?></span></small></label></div>      
        <br />		
			<div class="checkbox switcher">
      <label id="ss_subhead" for="chksfs">
		  ...
		  <small><span style="font-size:16px!important;"><?php _e( 'Enable Stop Forum Spam Lookups', 'stop-spammer-registrations-plugin' ); ?></span></small></label></div>
				<br />
			...
			<br />
        <br />
				<span class="keyhead"><?php _e( 'StopForumSpam.com API Key', 'stop-spammer-registrations-plugin' ); ?></span>
            <input size="32" name="apikey" type="text" value="<?php echo $apikey; ?>" /><br />
			<br />
				<span class="keyhead"><?php _e( 'Project Honeypot API Key', 'stop-spammer-registrations-plugin' ); ?></span>
        ...
        <br />
	<br />
			<span class="keyhead"><?php _e( 'BotScout API Key', 'stop-spammer-registrations-plugin' ); ?></span>
        ...
        <br />
	<br />
			<span class="keyhead"><?php _e( 'Google Safe Browsing API Key', 'stop-spammer-registrations-plugin' ); ?></span>
