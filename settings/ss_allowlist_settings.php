...
<div id="ss-plugin" class="wrap">
    <div><h1 class="ss_head"><?php _e( 'Stop Spammers — Allow Requests & Lists', 'stop-spammer-registrations-plugin' ); ?></h1>
	<br />
	<br />
	<div class="mainsection"><?php _e( 'Requests', 'stop-spammer-registrations-plugin' ); ?>
	...
	if ( count( $wlrequests ) == 0 ) {
		...
		?>
        <h3><?php _e( 'Allow List Requests', 'stop-spammer-registrations-plugin' ); ?></h3>
        ...
        <table name="mytable" id="myTable" style="width:100%;background-color:#eee" cellspacing="2">
            ...
            <tr style="background-color:#675682;color:white;text-align:center;text-transform:uppercase;font-weight:600">
                ...
                <th><?php _e( 'URL', 'stop-spammer-registrations-plugin' ); ?></th>
            </tr>
            </thead>
            <tbody id="wlreq">
			<?php
...
<div class="checkbox switcher">
      <label id="ss_subhead" for="chkwluserid">
		  ...
		  <small><span style="font-size:16px!important;"><?php _e( 'Enable Allow by User ID (not recommended)', 'stop-spammer-registrations-plugin' ); ?></span></small></label></div>
             <br />
 ...
 <br />
      ...
      <label id="ss_subhead" for="chkgoogle">
		  ...
		  <small><span style="font-size:16px!important;"><?php _e( 'Google (keep enabled under most circumstances)', 'stop-spammer-registrations-plugin' ); ?></span></small></label></div>
        <br />
<div class="checkbox switcher">
      <label id="ss_subhead" for="chkgenallowlist">
		  ...
		  <small><span style="font-size:16px!important;"><?php _e( 'Generated Allow List', 'stop-spammer-registrations-plugin' ); ?></span></small></label></div>
        <br />
<div class="checkbox switcher">
      <label id="ss_subhead" for="chkmiscallowlist">
		  ...
		  <small><span style="font-size:16px!important;"><?php _e( 'Other Allow Lists', 'stop-spammer-registrations-plugin' ); ?></span></small></label></div>
        <br />
<div class="checkbox switcher">
      <label id="ss_subhead" for="chkpaypal">
		  ...
		  <small><span style="font-size:16px!important;"><?php _e( 'Allow', 'stop-spammer-registrations-plugin' ); ?> PayPal</span></small></label></div>
        <br />
<div class="checkbox switcher">
      <label id="ss_subhead" for="chkstripe">
		  ...
		  <small><span style="font-size:16px!important;"><?php _e( 'Allow', 'stop-spammer-registrations-plugin' ); ?> Stripe</span></small></label></div>
        <br />
<div class="checkbox switcher">
      <label id="ss_subhead" for="chkauthorizenet">
		  ...
		  <small><span style="font-size:16px!important;"><?php _e( 'Allow', 'stop-spammer-registrations-plugin' ); ?> Authorize.Net</span></small></label></div>
        <br />
<div class="checkbox switcher">
      <label id="ss_subhead" for="chkbraintree">
		  ...
		  <small><span style="font-size:16px!important;"><?php _e( 'Allow', 'stop-spammer-registrations-plugin' ); ?> Braintree</span></small></label></div>
        <br />
<div class="checkbox switcher">
      <label id="ss_subhead" for="chkrecurly">
		  ...
		  <small><span style="font-size:16px!important;"><?php _e( 'Allow', 'stop-spammer-registrations-plugin' ); ?> Recurly</span></small></label></div>
        <br />
<div class="checkbox switcher">
      <label id="ss_subhead" for="chkyahoomerchant">
		  ...
		  <small><span style="font-size:16px!important;"><?php _e( 'Allow', 'stop-spammer-registrations-plugin' ); ?> Yahoo Merchant Services</span></small></label></div>
        <br />
<div class="checkbox switcher">
      <label id="ss_subhead" for="chkaws">
		  ...
		  <small><span style="font-size:16px!important;"><?php _e( 'Allow', 'stop-spammer-registrations-plugin' ); ?> Amazon Cloud</span></small></label></div>
        <br />
