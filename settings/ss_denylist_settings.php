	  ...
	  <label id="ss_subhead" for="chkspamwords">
		...
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkurlshort">
				...
				<span><small></small></span>
				<small>
					<span style="font-size:16px!important;">Check URL Shorteners</span>
				</small>
			</label>
			<i class="fa fa-question-circle fa-2x tooltip">
				<span class="tooltiptext">Use the URL Shorteners list to check comment body, email, and author fields. If a link here shows up in an email address or author field then block the comment. (wild cards do not work here). Add or delete URLs (one URL per line).</span>
			</i>
		</div>
		<br />
