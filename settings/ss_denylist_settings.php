...
<div id="ss-plugin" class="wrap">
	...
	<div class="mainsection">Personalised Block List
...
<div class="checkbox switcher">
	  <label id="ss_subhead" for="chkbluserid">
		  ...
		  <small><span style="font-size:16px!important;">Enable Block by User ID</span></small></label></div>
			 <br />
...
<div class="checkbox switcher">
	  <label id="ss_subhead" for="chkspamwords">
		  ...
		  <small><span style="font-size:16px!important;">Check Spam Words</span></small></label></div>
				<br />
	...
	<sup class="ss_sup"><a href="https://stopspammers.io/block-list/#urlshortening" target="_blank"><i class="fa fa-question-circle fa-2x tooltip"></i></a></sup></div>			
		<div class="checkbox switcher">
			<label id="ss_subhead" for="chkurlshort">
				...
				<span><small></small></span>
				<small>
					<span style="font-size:16px!important;">Check URL Shorteners</span></small></label></div>
		<br />
...
<div class="checkbox switcher">
	  <label id="ss_subhead" for="chkagent">
		  ...
		  <small><span style="font-size:16px!important;">Check Agents</span></small></label></div>
				<br />
